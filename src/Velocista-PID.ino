...
const int sensor_weights[8] = {0, 100, 60, 25, 25, 60, 105, 0};
...
void loop() {
    ...
    if(DEBUG)
    {
        ...
        Serial.print(" ||");
        Serial.print(" Speed_L="); Serial.print(constrain(BASE_SPEED + Output, MOTOR_MIN_PWM, MOTOR_MAX_PWM));
        Serial.print(" Speed_R="); Serial.print(constrain(BASE_SPEED - Output + MOTOR_RIGHT_OFFSET, MOTOR_MIN_PWM, MOTOR_MAX_PWM));
        Serial.print(" ||");
